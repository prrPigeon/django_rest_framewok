...
from fullgame.models import GameCategory
from fullgame.models import Game
from fullgame.models import Player
from fullgame.models import PlayerScore
...
# one to many (Foreign Key) relationship je read only
